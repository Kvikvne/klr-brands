 ...
 * alongside the JWT claims. Routing/redirect logic lives in the root middleware.ts.
 *
 * Do NOT add code between createServerClient and getClaims() — doing so can cause
